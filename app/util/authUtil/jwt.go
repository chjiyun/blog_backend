...
func GenerateJwtToken(jwtConfig config.JwtConfig, userId int64) (string, error) {
...
func RenewJwtToken(jwtConfig config.JwtConfig, userId int64, token string) error {
